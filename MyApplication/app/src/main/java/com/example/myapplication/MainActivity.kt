...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * SaveInstance methods are used to save variables in case orientation
     * switch resets all.
     */
    @Override
    ...
    /**
     * RestoreInstance restores necessary variables for orientation restoration
     */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val burgerButton = findViewById<Button>(R.id.burgerButton)
        ...
        /**
         * Burger Menu: Activation of this button shows a slide menu about valid input
         */
        ...
        eig?.setOnClickListener {                           //8 button activated
            ...
            nine?.setOnClickListener {                          //9 button activated
                ...
                dec?.setOnClickListener { //. button activated
                    screen.append(getString(R.string.dot))    //appends . to display
                }
                ...
                sub?.setOnClickListener {
                    ...
                    if ((basic && dataOp)||basic||screen.text == "") {
        ...
        clear?.setOnClickListener {
                 ...
                 */
                fun datasetParser(given: String) {
                    try{
                        var quote = given
                        if(given.get(given.lastIndex) == ',') {
                            quote = given.dropLast(1)
                        }
                        numbersList = arrayListOf()
        ...
        fun reassignData(numberToCut: Int): Double {
                    ...
                    while (counter < numbersList.size - counter) {
                        counter += 1
                        tempAr.add(numbersList[counter])
         ...
         */
                fun trimmedData(): Double {
                    ...
                    if (trimmThisMuch % 10 > 0) {
                        val upper = (trimmThisMuch / 10).toInt() + 1
                        val lower = (trimmThisMuch / 10).toInt() - 1
                        solution = reassignData(upper) - reassignData(lower)
        ...
        /**
         * Finds median of given dataset of numbers
         */
